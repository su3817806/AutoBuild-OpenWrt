...
#=================================================
#1. Modify default IP
sed -i 's/192.168.1.1/192.168.5.11/g' openwrt/package/base-files/files/bin/config_generate
...
#4. 版本号里显示一个自己的名字
sed -i "s/OpenWrt /Leji build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" openwrt/package/lean/default-settings/files/zzz-default-settings
